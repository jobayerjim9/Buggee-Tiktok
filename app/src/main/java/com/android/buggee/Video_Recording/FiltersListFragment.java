...
import com.android.buggee.SimpleClasses.SpacesItemDecoration;
...
public class FiltersListFragment extends Fragment implements ThumbnailsAdapter.ThumbnailsAdapterListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Bitmap bitmap = BitmapFactory.decodeFile(Variables.app_folder + Variables.output_story);
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap == null) {
                    thumbImage = BitmapUtils.getBitmapFromAssets(getActivity(), ImageEditingActivity.IMAGE_NAME, 100, 100);
                } else {
                ...
                List<Filter> filters = FilterPack.getFilterPack(context);
                Log.d("totalFilter", filters.size() + "");
