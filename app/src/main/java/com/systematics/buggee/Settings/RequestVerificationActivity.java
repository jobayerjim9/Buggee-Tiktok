...
import com.systematics.buggee.SimpleClasses.FileUtils;
...
public class RequestVerificationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(RequestVerificationActivity.this, R.style.AlertDialogCustom);
    ...
    public boolean check_permissions() {
        ...
        if (!MainMenuFragment.hasPermissions(RequestVerificationActivity.this, PERMISSIONS)) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            if (requestCode == 1) {
                ...
                base_64 = Functions.Bitmap_to_base64(RequestVerificationActivity.this, resized);
                ...
                try {
                    image_file = FileUtils.getFileFromUri(RequestVerificationActivity.this, selectedImage);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                InputStream imageStream = null;
    ...
    public void Call_api() {
        ...
        Functions.Show_loader(RequestVerificationActivity.this, false, false);
        ApiRequest.Call_Api(RequestVerificationActivity.this, Variables.getVerified, params, new Callback() {
            @Override
