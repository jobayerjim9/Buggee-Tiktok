...
//                 nuTracks.add(crop_track);
                ...
                progressDialog.dismiss();
                e.printStackTrace();
                Variables.output_filter_file = Variables.outputmain;
                Variables.outputfile2 = Variables.outputmain;
                Variables.outputfile = Variables.outputmain;
                Variables.output_filter_file_final = Variables.outputmain;
                Go_To_preview_Activity();
